...
%             [mean_dataset{i}, sd_dataset{i},background(:,:,i_img)] = GaussianAdaptativeClassify (inputFolder,dirList,j,param.gaussianColor,sd_dataset{i},mean_dataset{i},alphaMap(datasets(i).name),p,true,datasets(i).name);
%             i_img=i_img+1;
%         end
%         %Evaluation
